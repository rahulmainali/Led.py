...
e = Entry(root, width=45, borderwidth=4, font="lucida 10 bold")
...
button_equal = Button(root, text="=", padx=80, pady=16, command=lambda: button_click())
button_add = Button(root, text="+", padx=70, pady=16, command=lambda: button_click())
button_clear = Button(root, text="Clear", padx=75, pady=16, command=lambda: button_click())
